...
ANIMATION_BLOCKTELEPORT = [
    ('%s/blocks/portal8.png' % ICON_DIR),
    ('%s/blocks/portal7.png' % ICON_DIR),
    ('%s/blocks/portal6.png' % ICON_DIR),
    ('%s/blocks/portal5.png' % ICON_DIR),
    ('%s/blocks/portal4.png' % ICON_DIR),
    ('%s/blocks/portal3.png' % ICON_DIR),
